  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved music as @music" do
        ...
        post :create, {:music => { "title" => "invalid value" }}, valid_session
        assigns(:music).should be_a_new(Music)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested music" do
        ...
        Music.any_instance.should_receive(:update).with({ "title" => "MyString" })
        put :update, {:id => music.to_param, :music => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the music as @music" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Music.any_instance.stub(:save).and_return(false)
        put :update, {:id => music.to_param, :music => { "title" => "invalid value" }}, valid_session
        assigns(:music).should eq(music)
      end
